...
class LoginPageComp extends React.Component<IProps, IState> { // <IProps>
        ...
        return (
            <div className="loginPage">
                <form onSubmit={this.handleSubmit}>
                    <input id='name' value={this.state.name} type='text' onChange={this.handleOnChange} />
                    <input id='password' value={this.state.password} type='text' onChange={this.handleOnChange} />
    ...
    public handleOnChange(event: React.ChangeEvent) { // React.ChangeEvent
        // event.preventDefault();
